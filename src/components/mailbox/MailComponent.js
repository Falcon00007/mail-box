    ...
    const mailData = {
      ...
      try{
        const response = await fetch(
            `https://mail-box-client-3e379-default-rtdb.firebaseio.com//${changedSenderMail}SentMail.json`,
            {
              method: "POST",
      ...
      try {
        ...
        const response = await fetch(
          `https://mail-box-client-3e379-default-rtdb.firebaseio.com//${mail}Inbox.json`,
          {
            method: "POST",
            body: JSON.stringify({
              from: senderEmail,
